          ...
          <div class="mdc-elevation--z2 signup-form-container">
            ...
            <div class="form-content">
              <form
                ...
                v-on:submit="Form_OnSubmit($event)"
                novalidate="true"
              >
                ...
                <div class="form-content-item form-content-item--coluumns-2">
                  <div class="form-content-subitem">
                    <div
                      class="demo-text-field text-field-first-name mdc-text-field mdc-text-field--outlined"
                    >
                      <input
                        type="text"
                        id="signup-form-textfield-first-name"
                        name="first_name"
                        class="mdc-text-field__input"
                        v-on:keypress="LettersValidation_keypress($event)"
                        required
                      >
                      <div class="mdc-notched-outline">
                        ...
                        <div class="mdc-notched-outline__notch">
                          <label
                            for="signup-form-textfield-first-name"
                    ...
                    <p
                      id="signup-form-textfield-first-name-helper-text"
                  ...
                  <div class="form-content-subitem">
                    <div
                      class="demo-text-field text-field-last-name mdc-text-field mdc-text-field--outlined"
                    >
                      <input
                        type="text"
                        id="signup-form-textfield-last-name"
                        name="last_name"
                        class="mdc-text-field__input"
                        v-on:keypress="LettersValidation_keypress($event)"
                        required
                      ...
                      <div class="mdc-notched-outline">
                        ...
                        <div class="mdc-notched-outline__notch">
                          <label
                            for="signup-form-textfield-last-name"
                            class="mdc-floating-label"
                          >Last Name</label>
                        </div>
                        <div class="mdc-notched-outline__trailing"></div>
                    ...
                    <p
                      id="signup-form-textfield-last-name-helper-text"
                      class="mdc-text-field-helper-text"
                      aria-hidden="true"
                ...
                <div class="form-content-item form-content-item--coluumns-1">
                  <div class="form-content-subitem">
                    <div
                      class="demo-text-field text-field-full-name mdc-text-field mdc-text-field--outlined"
                    >
                      <input
                        type="text"
                        id="signup-form-textfield-full-name"
                        name="full_name"
                        class="mdc-text-field__input"
                        v-on:keypress="LettersValidation_keypress($event)"
                        required
                      ...
                      <div class="mdc-notched-outline">
                        ...
                        <div class="mdc-notched-outline__notch">
                          <label
                            for="signup-form-textfield-full-name"
                            class="mdc-floating-label"
                          >Full Name</label>
                        </div>
                        <div class="mdc-notched-outline__trailing"></div>
                    ...
                    <p
                      id="signup-form-textfield-full-name-helper-text"
                      class="mdc-text-field-helper-text"
                      aria-hidden="true"
                    >The name that should be mentioned in the certificate.</p>
                  </div>
                </div>
                <div class="form-content-item form-content-item--coluumns-2">
                  <div class="form-content-subitem">
                      ...
                      <div class="birthday-section-inner">
                        ...
                        <div class="birthday">
                          <div class="birthday-inner">
                            <div class="day">
                              <div
                                class="demo-text-field text-field-birthday-day mdc-text-field mdc-text-field--outlined"
                              >
                                <input
                                  type="text"
                                  id="signup-form-textfield-birthday-day"
                                  name="dob_day"
                                  class="mdc-text-field__input"
                                  v-on:keypress="NumericValidation_keypress($event)"
                                  required
                                >
                                <div class="mdc-notched-outline">
                                  <div class="mdc-notched-outline__leading"></div>
                                  <div class="mdc-notched-outline__notch">
                                    <label
                                      for="signup-form-textfield-birthday-day"
                                      class="mdc-floating-label"
                                    >Day</label>
                                  </div>
                                  <div class="mdc-notched-outline__trailing"></div>
                            ...
                            <div class="month">
                              <div
                                class="mdc-select demo-width-class mdc-select--outlined signup-form-select-birthday-month"
                                v-on:focusout="DOBMonth_focusOut()"
                                v-on:focusin="DOBMonth_focusIn()"
                              >
                                <input
                                  type="hidden"
                                  name="dob_month"
                                  id="signup-form-select-birthday-month"
                                  required
                                >
                            ...
                            <div class="year">
                              <div
                                class="demo-text-field text-field-birthday-year mdc-text-field mdc-text-field--outlined"
                              >
                                <input
                                  type="text"
                                  id="signup-form-textfield-birthday-year"
                                  name="dob_year"
                                  class="mdc-text-field__input"
                                  v-on:keypress="NumericValidation_keypress($event)"
                                  required
                                ...
                                <div class="mdc-notched-outline">
                                  ...
                                  <div class="mdc-notched-outline__notch">
                                    <label
                                      for="signup-form-textfield-birthday-year"
                                      class="mdc-floating-label"
                                    >Year</label>
                                  </div>
                                  <div class="mdc-notched-outline__trailing"></div>
                  ...
                  <div class="form-content-subitem">
                    <div class="gend">
                      <div
                        class="mdc-select demo-width-class mdc-select--outlined signup-form-select-gender"
                        v-on:focusout="Gender_focusOut()"
                        v-on:focusin="Gender_focusIn()"
                      >
                        ...
                        <div class="mdc-select__menu mdc-menu mdc-menu-surface demo-width-class">
                          <ul class="mdc-list">
                            <li
                              ...
                              aria-selected="true"
                            ></li>
                            <li class="mdc-list-item" data-value="male">Male</li>
                            <li class="mdc-list-item" data-value="female">Female</li>
                            <li class="mdc-list-item" data-value="other">Other</li>
                          </ul>
                        </div>
                        <div class="mdc-notched-outline">
                          <div class="mdc-notched-outline__leading"></div>
                      ...
                      <p
                        id="signup-form-select-gender-helper-text"
                ...
                <div class="form-content-item form-content-item--coluumns-1">
                  <div class="form-content-subitem">
                    <div
                      class="demo-text-field text-field-school mdc-text-field mdc-text-field--outlined"
                    >
                      <input
                        type="text"
                        id="signup-form-textfield-school"
                        name="school_name"
                        class="mdc-text-field__input"
                        required
                      >
                      <div class="mdc-notched-outline">
                        ...
                        <div class="mdc-notched-outline__notch">
                          <label
                            for="signup-form-textfield-school"
                            class="mdc-floating-label"
                          >School Name</label>
                        </div>
                        <div class="mdc-notched-outline__trailing"></div>
                    ...
                    <p
                      id="signup-form-textfield-school-helper-text"
                      class="mdc-text-field-helper-text"
                      aria-hidden="true"
                    >Enter your school name.</p>
                  </div>
                </div>
                  ...
                  <div class="form-content-subitem">
                    <div class="address-container">
                      ...
                      <div class="address-fields">
                        <div>
                          <div
                            class="demo-text-field text-field-address-1 mdc-text-field mdc-text-field--outlined"
                          >
                            <input
                              type="text"
                              id="signup-form-textfield-address-1"
                              name="address_1"
                              class="mdc-text-field__input"
                              required
                            >
                            <div class="mdc-notched-outline">
                              ...
                              <div class="mdc-notched-outline__notch">
                                <label
                                  for="signup-form-textfield-address-1"
                                  class="mdc-floating-label"
                                >Address 1</label>
                              </div>
                              <div class="mdc-notched-outline__trailing"></div>
                          ...
                          <p
                            id="signup-form-textfield-address-1-helper-text"
                            class="mdc-text-field-helper-text"
                            aria-hidden="true"
                          >Address 1.</p>
                        </div>
                        <div>
                          <div
                            class="demo-text-field text-field-address-2 mdc-text-field mdc-text-field--outlined"
                          >
                            <input
                              type="text"
                              id="signup-form-textfield-address-2"
                              name="address_2"
                              class="mdc-text-field__input"
                            >
                            <div class="mdc-notched-outline">
                              ...
                              <div class="mdc-notched-outline__notch">
                                <label
                                  for="signup-form-textfield-address-2"
                                  class="mdc-floating-label"
                                >Address 2</label>
                              </div>
                              <div class="mdc-notched-outline__trailing"></div>
                          ...
                          <p
                            id="signup-form-textfield-address-2-helper-text"
                            class="mdc-text-field-helper-text"
                            aria-hidden="true"
                          >Address 2.</p>
                        </div>
                ...
                <div class="form-content-item form-content-item--coluumns-2 contact">
                  <div class="form-content-subitem">
                    <div
                      class="demo-text-field text-field-contact-no mdc-text-field mdc-text-field--outlined"
                    >
                      <input
                        type="text"
                        id="signup-form-textfield-contact-no"
                        name="contact_number"
                        class="mdc-text-field__input"
                        v-on:keypress="ContactNoValidation_keypress($event)"
                        required
                      >
                      <div class="mdc-notched-outline">
                        <div class="mdc-notched-outline__leading"></div>
                        <div class="mdc-notched-outline__notch">
                          <label
                            for="signup-form-textfield-contact-no"
                            class="mdc-floating-label"
                          >Contact No (E.g : 0776584010)</label>
                        </div>
                        <div class="mdc-notched-outline__trailing"></div>
                      </div>
                    </div>
                    <p
                      id="signup-form-textfield-contact-no-helper-text"
                      class="mdc-text-field-helper-text"
                      aria-hidden="true"
                    >Enter your contact no. (E.g : 0776584010)</p>
                  </div>
                  <div class="form-content-subitem">
                    <div
                      class="demo-text-field text-field-email mdc-text-field mdc-text-field--outlined"
                    >
                      <input
                        type="text"
                        id="signup-form-textfield-email"
                        name="email"
                        class="mdc-text-field__input"
                        required
                      >
                    ...
                    <p
                      id="signup-form-textfield-email-helper-text"
                      class="mdc-text-field-helper-text"
                      aria-hidden="true"
                    >Enter your email.</p>
                  </div>
                ...
                <div class="desc proof-doc">
                  <p
                    class="dc"
                  >Please attach a scanned copy or a photograph of any one of following documents to verify your identity.</p>
                  <div class="list--">
                    <ul>
                ...
                <div class="form-content-item form-content-item--coluumns-2 document">
                  <div class="form-content-subitem">
                    <div
                      class="mdc-select demo-width-class mdc-select--outlined signup-form-select-document-type"
                      v-on:focusout="DocumentType_focusOut()"
                      v-on:focusin="DocumentType_focusIn()"
                    >
                      <input
                        type="hidden"
                        name="document_type"
                        id="signup-form-select-document-type"
                        required
                      >
                      <i class="mdc-select__dropdown-icon"></i>
                      <div class="mdc-select__selected-text"></div>
                      <div class="mdc-select__menu mdc-menu mdc-menu-surface demo-width-class">
                        <ul class="mdc-list">
                          <li
                            ...
                            aria-selected="true"
                          ></li>
                          <li class="mdc-list-item" data-value="Postal ID">Postal ID</li>
                          <li class="mdc-list-item" data-value="National ID">National ID</li>
                          <li class="mdc-list-item" data-value="Passport">Passport</li>
                          <li class="mdc-list-item" data-value="Letter">Letter</li>
                        </ul>
                      </div>
                      <div class="mdc-notched-outline">
                        <div class="mdc-notched-outline__leading"></div>
                    ...
                    <p
                      id="signup-form-select-document-type-helper-text"
                      class="mdc-select-helper-text"
                      aria-hidden="true"
                    >Select your document type.</p>
                  </div>
                  <div class="form-content-subitem">
                    <div
                      class="demo-text-field text-field-document-no mdc-text-field mdc-text-field--outlined"
                    >
                      <input
                        type="text"
                        id="signup-form-textfield-document-no"
                      ...
                      <div class="mdc-notched-outline">
                        ...
                        <div class="mdc-notched-outline__notch">
                          <label
                            for="signup-form-textfield-document-no"
                            class="mdc-floating-label"
                          >Postal ID / National ID / Passport number.</label>
                        </div>
                        <div class="mdc-notched-outline__trailing"></div>
                      </div>
                    </div>
                    <p
                      id="signup-form-textfield-document-no-helper-text"
                      class="mdc-text-field-helper-text"
                      aria-hidden="true"
                    >Enter your Postal ID / National ID / Passport number.</p>
                  </div>
                  <div class="form-content-subitem">
                      ...
                      <div class="file-upload-container">
                        <div class="uploaded-file-container">
                          <input
                            type="file"
                            name="file_document"
                            id="signup-form-file-document"
                            v-on:invalid="FileUpload_invalid($event)"
                            v-on:change="FileUpload_change($event)"
                            required
                          >
                          <button
                            class="mdc-button"
                            id="file-upload-action-button"
                            v-on:click="FileUploadButton_click($event)"
                          >
                            <i
                          ...
                          <p
                            id="signup-form-textfield-upload-document-helper-text"
                            class="mdc-text-field-helper-text"
                            aria-hidden="true"
                          >Upload a scanned copy of your Postal ID / National ID / Passport.</p>
...
var textField_FirstName,
  textField_LastName,
  textField_FullName,
  textField_BirthdayDay,
  textField_BirthdayYear,
  textField_School,
  textField_Address1,
  textField_Address2,
  textField_ContactNo,
  textField_Email,
  textField_DocumentNo; // textFields
var select_BirthdayMonth_Element,
  select_Gender_Element,
  select_DocumentType_Element; // selectElements
var select_BirthdayMonth, select_Gender, select_DocumentType; // selectFields
var helperText_FirstName,
  helperText_LastName,
  helperText_FullName,
  helperText_Gender,
  helperText_School,
  helperText_Address1,
  helperText_Address2,
  helperText_ContactNo,
  helperText_Email,
  helperText_DocumentNo,
  helperText_DocumentType,
  helperText_DocumentUpload; // helperTexts
// file upload
...
var Fields_Validation_By_Class = (
  element,
  class_name = "mdc-text-field--invalid"
) => {
...
var DOB_Validate = (day, month, year) => {
  if (
    ...
    if (min_date <= date && max_date >= date) {
      ...
      SnackBarShowMessage(
        "Your date of birth must in between 1999/7/1 and 2019/7/1."
      );
      return false;
    }
  }
...
var ContactNo_Validate = number => {
  if (number == null || number == "") {
    ...
    if (regx.test(number)) {
      ...
      SnackBarShowMessage(
        "Please fill a valid contact number (E.g : 0776584010 or +94776584010)."
      );
      return false;
    }
  }
...
var Form_validate = () => {
  if (textField_FirstName == null || textField_FirstName.value == "") {
    ...
    textField_LastName.value == null ||
    textField_LastName.value == ""
  ) {
    ...
    textField_FullName.value == null ||
    textField_FullName.value == ""
  ) {
    ...
    !DOB_Validate(
      textField_BirthdayDay.value,
      select_BirthdayMonth.value,
      textField_BirthdayYear.value
    )
  ) {
    ...
    textField_Address1.value == null ||
    textField_Address1.value == ""
  ) {
    ...
    !Document_validate(select_DocumentType.value, textField_DocumentNo.value)
  ) {
    console.log("doc type error");
    return false;
...
var reCAPTCHA_set = () => {
  return new Promise((resolve, reject) => {
    grecaptcha.ready(function() {
      try {
        grecaptcha
          .execute("6LfJjI4UAAAAACjEIuGGUDaUjQ6gJ6Iwi3IZJS5J", {
            action: "signup"
          })
          .then(function(token) {
...
export default {
  ...
  methods: {
    DOBMonth_focusOut: () => {
      if (select_BirthdayMonth.value === "") {
        ...
        select_BirthdayMonth_Element.classList.contains("mdc-select--invalid")
      ) {
        select_BirthdayMonth_Element.classList.remove("mdc-select--invalid");
    ...
    Gender_focusOut: () => {
      if (select_Gender.value === "") {
        ...
        select_Gender_Element.classList.contains("mdc-select--invalid")
      ) {
        select_Gender_Element.classList.remove("mdc-select--invalid");
      } else if (select_Gender.value !== "") {
        select_Gender_Element.classList.remove("mdc-select--invalid");
    ...
    DocumentType_focusOut: () => {
      if (select_DocumentType.value === "") {
        ...
        select_DocumentType_Element.classList.contains("mdc-select--invalid")
      ) {
        select_DocumentType_Element.classList.remove("mdc-select--invalid");
    ...
    FileUpload_invalid: event => {
      if (event.target.value == null) {
        ...
        fileUploadContainer.classList.contains("file-upload-container--invlid")
      ) {
    ...
    FileUpload_change: event => {
      ...
      if (event.target.value == null) {
        ...
        if (
          fileUploadContainer.classList.contains(
            "file-upload-container--invlid"
          )
        ) {
          fileUploadContainer.classList.remove("file-upload-container--invlid");
        }
        ...
        document
          .querySelector("#upload-cancel-btn")
        ...
        reCAPTCHA_set()
          .then(() => {
            return axios.post(
              ...
              new FormData(document.getElementById("signup-form")),
              {
                headers: {
  ...
  mounted: () => {
    textField_FirstName = new MDCTextField(
      document.querySelector(".text-field-first-name")
    );
    textField_LastName = new MDCTextField(
      document.querySelector(".text-field-last-name")
    );
    textField_FullName = new MDCTextField(
      document.querySelector(".text-field-full-name")
    );
    textField_BirthdayDay = new MDCTextField(
      document.querySelector(".text-field-birthday-day")
    );
    textField_BirthdayYear = new MDCTextField(
      document.querySelector(".text-field-birthday-year")
    );
    select_BirthdayMonth_Element = document.querySelector(
      ".signup-form-select-birthday-month"
    );
    ...
    select_Gender_Element = document.querySelector(
      ".signup-form-select-gender"
    );
    ...
    textField_School = new MDCTextField(
      document.querySelector(".text-field-school")
    );
    textField_Address1 = new MDCTextField(
      document.querySelector(".text-field-address-1")
    );
    textField_Address2 = new MDCTextField(
      document.querySelector(".text-field-address-2")
    );
    textField_ContactNo = new MDCTextField(
      document.querySelector(".text-field-contact-no")
    );
    textField_Email = new MDCTextField(
      document.querySelector(".text-field-email")
    );
    textField_DocumentNo = new MDCTextField(
      document.querySelector(".text-field-document-no")
    );

    select_DocumentType_Element = document.querySelector(
      ".signup-form-select-document-type"
    );
    ...
    fileUploadActionButton = document.querySelector(
    ...
    helperText_FirstName = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-first-name-helper-text")
    );
    helperText_LastName = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-last-name-helper-text")
    );
    helperText_FullName = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-full-name-helper-text")
    );
    helperText_Gender = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-select-gender-helper-text")
    );
    helperText_School = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-school-helper-text")
    );
    helperText_Address1 = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-address-1-helper-text")
    );
    helperText_Address2 = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-address-2-helper-text")
    );
    helperText_ContactNo = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-contact-no-helper-text")
    );
    helperText_Email = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-email-helper-text")
    );
    helperText_DocumentNo = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-textfield-document-no-helper-text")
    );
    helperText_DocumentType = new MDCTextFieldHelperText(
      document.querySelector("#signup-form-select-document-type-helper-text")
    );

    helperText_DocumentUpload = new MDCTextFieldHelperText(
      document.querySelector(
        "#signup-form-textfield-upload-document-helper-text"
      )
    );
    ...
    grecaptcha.ready(function() {
      grecaptcha.execute("6LfJjI4UAAAAACjEIuGGUDaUjQ6gJ6Iwi3IZJS5J", {
        action: "signupPage"
      });
    });
  }
